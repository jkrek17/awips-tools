"""Pytest bootstrap for the retired vorticity-proxy reference tests.

Puts `reference/vorticity_proxy` (the retired vorticity-proxy module) on sys.path so `import CycloneCore`
...
_FUNCTIONS_DIR = os.path.abspath(
    os.path.join(os.path.dirname(__file__), "..", "..", "reference", "vorticity_proxy")
)
