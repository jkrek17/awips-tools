...
// not live bulletins. See BestTrackData.gs (generated by
// tests/tcwind_jtwc/prep_besttrack_data.py) and tests/tcwind_jtwc/README.md.
// ---------------------------------------------------------------------------

/** 100 sampled storms' full tracks, for the storm browser. */
function getBestTrackSample() {
  return BEST_TRACK_SAMPLE;
}

/** Every usable WP best-track record, compact, for the verification scatter. */
function getBestTrackScatter() {
