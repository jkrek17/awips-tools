...
class, and the index. The capture is the North Atlantic at 6 hours of
the 24 September run: HB paints the polar front magenta, HVTU is blue
under the jet, and the 959 millibar low south of Greenland reads as a
warm seclusion, red lower core, blue upper, B near zero at the center
with the magenta band wrapped around it. The class reads at the
